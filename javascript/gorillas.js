...
function loadImages(){
	...
	explosionObj.src = './img/explosion.png';
	pointerObj = new Image();
	pointerObj.onload = imageLoaded;
	pointerObj.src = './img/pointer.png';
	sunObj = new Image();
	sunObj.onload = imageLoaded;
	sunObj.src = './img/sun.png';
	skyObj = new Image();
	skyObj.onload = imageLoaded;
	skyObj.src = './img/sky_gradient.png';
	windowObj = new Image();
	...
	idle_gorilla.src = './img/idle.png';
	throwing_gorilla[0].src = './img/throw1.png';
	throwing_gorilla[1].src = './img/throw2.png';
	win_gorilla.src = './img/win.png';
	loser_gorilla.src = './img/loser.png';
	bananaObj = new Image();
	bananaObj.onload = imageLoaded;
	bananaObj.src = './img/Banana.png';
